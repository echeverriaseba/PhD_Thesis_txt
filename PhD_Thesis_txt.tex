...
\newcommand{\supervisorone}{Dr. Maite Martínez Eixarch}  % Added by Seba
\newcommand{\supervisortwo}{Dr. Néstor Pérez Méndez}  % Added by Seba

\usepackage{etoolbox} % Added by Seba to avoid red lists
\pretocmd{\tableofcontents}{\hypersetup{linkcolor=black}}{}{}
\pretocmd{\listoffigures}{\hypersetup{linkcolor=black}}{}{}
\pretocmd{\listoftables}{\hypersetup{linkcolor=black}}{}{}
...
%\usepackage{siunitx} % added by Seba for coordinates formatting
...
%\usepackage[demo]{graphicx} % Added by Seba to set captions on the side
%\usepackage[capbeside]{floatrow}
%\floatsetup[figure]{style=plain,capbesideposition={left,top},capbesidewidth=4.5cm}
...
%\supervisor1{Dra. Maite \textsc{Martínez Eixarch}}
%\supervisor2{Dr. Néstor \textsc{Pérez Méndez}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Sebastián Echeverría Progulakis} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
\addresses{} % Your address, this is not currently used anywhere in the template, print it elsewhere with \addressname

\subject{Biological Sciences} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
\keywords{} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
\university{\href{https://www.udg.edu/en/}{Universitat de Girona}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
\department{\href{https://www.udg.edu/en/estudia/oferta-formativa/programes-de-doctorat/doctorat?IDE=2470&ID=350130513}{Programa de Doctorat en Medi Ambient}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
{\large
\emph{Author:}\\
\href{https://orcid.org/0000-0003-0592-9436}{\authorname}\\} % Author name - remove the \href bracket to remove the link
%\end{flushleft}
%\end{minipage}
\vspace*{.03\textheight}
%\begin{minipage}[t]{0.4\textwidth}
...
\href{https://orcid.org/0000-0002-7352-8522}{\supervisorone}\\
\href{https://orcid.org/0000-0001-6264-2920}{\supervisortwo}}\\ % Supervisor name - remove the \href bracket to remove the link  
%\end{flushleft}
%\end{minipage}\\
[3cm]
...
\textbf{GWP} & \textbf{G}lobal \textbf{w}arming \textbf{p}otential\\
\textbf{GWPY} & \textbf{Y}ield scaled \textbf{g}lobal \textbf{w}arming \textbf{p}otential\\
\textbf{SDGs} & \textbf{S}ustainable \textbf{d}evelopment \textbf{g}oals\\
\textbf{CSA} & \textbf{C}limate-\textbf{S}mart \textbf{A}griculture\\
\textbf{NBS} & \textbf{N}ature-\textbf{B}ased \textbfs{S}olutions\\
...
\include{Chapters/Paper_1_2ndrev}
\include{Chapters/Paper_2} 
